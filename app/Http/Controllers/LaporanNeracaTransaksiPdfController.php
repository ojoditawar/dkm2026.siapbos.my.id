...
class LaporanNeracaTransaksiPdfController extends Controller
{
    public function export()
    {
        // Get data from session
        $exportData = session('neraca_transaksi_export_data');
        ...
        // Generate filename
        $filename = 'laporan-neraca-transaksi-' .
        ...
        // Clear session data
        session()->forget('neraca_transaksi_export_data');
