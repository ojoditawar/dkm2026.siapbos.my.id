...
use App\Filament\Resources\Penguruses\Pages\ViewPengurus;
use App\Filament\Resources\Penguruses\Schemas\PengurusForm;
use App\Filament\Resources\Penguruses\Schemas\PengurusInfolist;
...
class PengurusResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'RUH Pengurus DKM';
    ...
    {
        return PengurusInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewPengurus::route('/{record}'),
